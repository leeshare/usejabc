...
public abstract class BasePtOperator<M extends BasePtOperator<M>> extends Model<M> implements IBean {
	...
	public void setCsrf(java.lang.String csrf) {
		set("csrf", csrf);
	}
	...
	public void setSyslog(java.lang.String syslog) {
		set("syslog", syslog);
	}
